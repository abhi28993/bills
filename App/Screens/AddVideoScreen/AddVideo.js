...
import Styles from './AddVideoStyle';
...
class AddPost extends Component {
  ...
  multipleImage() {
    ...
    ImagePicker.openPicker({
      ...
      // console.log('hiiiiiiiiiiiiiii', this.state.avatarSource);
    });
  }
        ...
        <View style={Styles.mainScreen}>
          <View style={Styles.underHeader}>
            ...
            <View style={Styles.headMainText}>
              <Text style={Styles.textHeding}>{StringC.videoPost}</Text>
            </View>
            <TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Text style={Styles.embdedText}>{StringC.videoEmbedPost}</Text>
          </TouchableOpacity>
          <View style={Styles.customMain} />
            ...
            <View style={Styles.flatMain}>
              <ImageBackground
                ...
                <View style={Styles.iconMain}>
                  <TouchableOpacity
                    onPress={() => {
                      this.removeImage(this.state.avatarSource);
                    }}
